		...
		'validateOnSubmit'=>true,
                            ...
                            <div class="user-info has-layout  charge-source bottom">
                                <div class="precharge-intro">
                                    ...
                                    <p>1、当支付金额大于订单金额， 余额会保存在您的专业翻译账户。</p>
                                    <p>2、余额可以下次直接支付，省去多次充值的不便。</p>
                                    <p>3、所剩余额，均可电话申请退款。</p>
                                </div>
                                <div class="pay-method has-layout user-info ">
                                    ...
                                    <div class="accounts">
                                        ...
                                        <i id="price" class="large"><?php echo $order->price; ?>元</i>
                                         <label>账户余额：</label>
                                         <i id="balance" class="large"><?php echo $user->balance; ?>元</i>
                                    </div>
...
<label class="sp alipay" for="ChongzhiForm_recharge_way_0"></label>
                            ...
                            <div class="user-info charge-control has-layout" style="position:relative;">
                                <?php echo CHtml::button('下一步', array('submit' => array('user/chongzhi','source'=>$order->type,'orderId'=>$order->id,'userId'=>$user->email),"class"=>"clog-js control-btn")); ?>
