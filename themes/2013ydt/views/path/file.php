<?php
$this->pageTitle=Yii::app()->name . ' - 文档翻译';
...
<link type="text/css" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/default/trans.css" rel="stylesheet">
    <div id="bd" class="trans">
        <div class="tab">
			...
			<?php echo CHtml::link("文档翻译",array('/path/file'),array("class"=>"doc-trans current","title"=>"文档翻译","rel"=>"nofollow")); ?>
			<?php echo CHtml::link("收费标准",array('/path/about',"#"=>"doc-file"),array("class"=>"message-tip","rel"=>"nofollow", "target"=>"_blank","title"=>"点击查看")); ?>
        </div>
...
$this->widget('ext.EUserFlash',array(
    'initScript'=>"$('.userflash_success').fadeOut(9999999999);$('.userflash_notice').fadeOut(99999999990);"
));
?>
    ...
    'clientOptions'=>array(
      'validateOnSubmit'=>true,
            ...
            <div class="file-info">
                ...
                <span class="form-item-layout additional">请上传doc、docx、txt、pdf、rar、zip格式的文件。
            ...
            <?php echo CHtml::button('提交翻译', array('submit' => array('path/file'),"class"=>"form-item-layout control-btn flog-js")); ?>
