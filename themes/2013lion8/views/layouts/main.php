...
<div id="doc1">
  <div id="hd"> <a href="<?php echo Yii::app()->homeUrl; ?>" class="logo" data-act="logo"></a>
      ...
      <div>
        <div>
          ...
          <?php if(Yii::app()->user->checkAccess('interpreter') || Yii::app()->user->checkAccess('operator')): ?>
            ...
            <div class="li-left">|</div>
            <div class="li-left"><?php echo CHtml::link('客户反馈',array('/user/orderComments')); ?></div>
    ...
    <div class="contact">
      <div class="navigation"> <?php echo CHtml::link("首页",array('/path/index')); ?> <?php echo CHtml::link("快速翻译",array('/path/fast')); ?> <?php echo CHtml::link("文档翻译",array('/path/file')); ?> <?php echo CHtml::link('网站翻译',array('/path/webSite')); ?> <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/new.jpg"  style="position:absolute;top:-8px;left:640px;_left:545px" /> <?php echo CHtml::link("服务说明",array('/path/about')); ?></div>
    </div>
  </div>
  <!---hd end--> 
