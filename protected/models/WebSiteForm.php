<?php
class WebSiteForm extends CActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('document', 'file',  'allowEmpty'=>false, 'types'=>'doc,docx,xls,xlsx,txt,htm,html,htmls,xhtml,rar,zip', 'wrongType'=>'不支持的文件类型', 'maxSize' => 1024 * 1024 * 20, 'tooLarge' => '文件大小不能超过20M', 'message'=>'请选择文件'),
